...
export default function SignupStudentPage() {
  ...
  const { token, invite, loading, error } = useSignupInvite('STUDENT')
    ...
    <SignupInviteGate loading={loading} error={error} invite={invite}>
      {(resolvedInvite) => (
        <div className="ams-card ams-auth__card">
          <h1 className="ams-card__title">학생 가입</h1>
          ...
          <form className="ams-form" onSubmit={handleSubmit}>
            ...
            <label className="ams-consent">
              ...
              <span>
                ...
                <br />
                본인은 AMS 서비스 회원가입과 학원 운영(수강생 관리, 수업/과제/클리닉 운영, 본인 확인 및 고객 응대)을 위해 이름, 이메일,
