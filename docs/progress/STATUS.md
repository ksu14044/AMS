...
> **마지막 갱신:** 2026-06-04 (Phase 12.10 QA 수정 착수)  
...
- **QA 보완:** `AdminSignupInvitesSection` `issueParentLink` (원장 홈 빈 화면) · `parent.css` UI · `requireReadableReport` 학부모 PDF 403 수정
...
## Phase 12.10 — QA·배포 전 수정 🟡

> Phase 11 **전** 반영. [PHASE-12-10-SCOPE.md](./PHASE-12-10-SCOPE.md)

| 슬라이스 | 상태 | 비고 |
|----------|------|------|
| **12.10-1** 정답지·배포 업로드 | ✅ | 원본 저장 · Docker `/data/uploads` 권한 |
| **12.10-2** 자동 완료·정렬 | ✅ | 완료 처리 제거 · 미입력 우선 |
| **12.10-3** 채점 UI | ✅ | 맞은 수 / 틀린 문항 · `countOnlyGrading` |
| **12.10-4** UI | ✅ | 홈 스크롤 · 학원코드 회색 |
| **12.10-5** 보고서 PNG | ✅ | FE `html-to-image` · 학부모 모달 조회 |
...
1. **12.10-1** — 배포 업로드 권한 · 정답지 원본 저장
2. **12.10-2** — 완료 처리 제거 · 자동 완료 · 확인 탭 정렬
3. **12.10-3~6** — 채점 UI · UI · 보고서 PNG · `/signup`

## 다음 할 일

1. **Phase 12.10** 나머지 슬라이스
2. **Phase 11** — E2E·감사·rate limit (12.10 완료 후)
...
| 날짜 | 요약 |
|------|------|
| [2026-06-04](./daily/2026-06-04.md) | Phase 12.10 QA 수정 착수 · 문서 확정 |
| [2026-06-03](./daily/2026-06-03.md) | 12-8·12-9 ✅ · 학부모 UI/PDF QA |
