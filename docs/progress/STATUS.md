...
> **마지막 갱신:** 2026-06-01 (12-6 완료 · 알림·미완료 과제 연동)  
...
| 항목 | 상태 |
|---|---|
| **현재 Phase** | **12-7** 클리닉 프리셋 🔲 |
| **다음 Phase** | 12-7~12-9 |
| **최종 Phase** | **11 운영** |
| **전체 진행** | Phase 0~10 ✅ / **12-1~12-6 ✅** / 12-7~9·11 🔲 |
...
1. **12-7** — 클리닉 프리셋 (`preset` · start_time only · capacity 10)
2. 수업기록 귀속 항목 CRUD 실사용 QA
3. ~~Phase 11~~ — 12 완료 후
