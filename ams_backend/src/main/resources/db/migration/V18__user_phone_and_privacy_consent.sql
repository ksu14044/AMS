...
ALTER TABLE `user` ADD COLUMN personal_info_consent_at TIMESTAMP NULL;
...
ALTER TABLE `user` MODIFY COLUMN phone_number VARCHAR(20) NOT NULL;
ALTER TABLE `user` MODIFY COLUMN personal_info_consent_at TIMESTAMP NOT NULL;
