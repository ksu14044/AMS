...
> **마지막 갱신:** 2026-06-01 (12-5 완료 · accessible_from 연동)  
...
| 항목 | 상태 |
|---|---|
| **현재 Phase** | **12-6** 알림 개편 (ACTIVE/DISMISSED · D-1 폐기) 🔲 |
| **다음 Phase** | 12-6~12-9 |
| **최종 Phase** | **11 운영** |
| **전체 진행** | Phase 0~10 ✅ / **12-1~12-5 ✅** / 12-6~9·11 🔲 |
...
1. **12-6** — 알림 상태 개편(`ACTIVE`/`DISMISSED`) 및 D-1 제거 반영
2. 알림 홈 미완료 카드 정책 확정 및 API/화면 반영 범위 정리
3. 수업기록 귀속 항목 CRUD 실사용 QA (완료·채점·예약 후 수정/삭제 잠금 확인)
...
| 날짜 | 요약 |
|------|------|
| [2026-06-01](./daily/2026-06-01.md) | 12-5 완료 · 접근 시점 필터 및 관리자 배정 UI |
